...
const hasher = require("../utils/hashing-password");
        ...
        if (
            ...
            try {
                ...
                if (isExist) {
                    ...
                    const hashedPassword = await hasher.makeHash(password);
                    ...
                    if (await newUser.save()) {
                        ...
                        const token = await jwt.encodeJWT({
                            id: currentID,
                            name,
                            email
                        });
            ...
            try {
                ...
                if (isExist) {
                    if (isExist.email === email.trim()) {
                        const isOkPassword = await hasher.compareHashed(
                            password,
                            isExist.password
                        );
                        if (isOkPassword) {
